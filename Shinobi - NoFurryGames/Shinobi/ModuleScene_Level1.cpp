...
bool ModuleScene_Level1::Start()
{
	...
	App->collisions->AddCollider({ 416, 186, 62, 15 }, Collider::Type::BOX_HELP); //CAJA 1 - IZQUIERDA
	App->collisions->AddCollider({ 388, 186, 62, 15 }, Collider::Type::BOX_HELP_RIGHT); //CAJA 1 - DERECHA
